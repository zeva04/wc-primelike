...
export const WC_DATA = {
  teams: [
    ...
    },
    {
      ...
      players: [
        { name: "Zion Suzuki",     pos: "POR", num:  1, stats: { atajadas: 82, reflejos: 84, salidas: 78, pase: 74, aura: 74 }, look: { skin: "#A0663A", hair: "#0E0C0A", style: "buzz", beard: false } },
        { name: "Tomoki Hayakawa", pos: "POR", num: 23, stats: { atajadas: 76, reflejos: 78, salidas: 72, pase: 70, aura: 70 }, look: { skin: "#F1C27D", hair: "#0E0C0A", style: "short", beard: false } },
        ...
        { name: "Sugawara",         pos: "DEF", num:  2, stats: { tiro: 62, defensa: 76, cabezazo: 66, pase: 80, aura: 70 }, look: { skin: "#F1C27D", hair: "#0E0C0A", style: "buzz", beard: false } },
        ...
        { name: "Take Kubo",        pos: "MED", num:  8, stats: { tiro: 82, defensa: 56, cabezazo: 58, pase: 86, aura: 82 }, look: { skin: "#F1C27D", hair: "#2A1D12", style: "short", beard: false } },

        { name: "Daizen Maeda",     pos: "DEL", num: 11, stats: { tiro: 84, defensa: 48, cabezazo: 60, pase: 80, aura: 82 }, look: { skin: "#F1C27D", hair: "#17130F", style: "buzz", beard: false } },
        { name: "Ayase Ueda",       pos: "DEL", num: 18, stats: { tiro: 80, defensa: 44, cabezazo: 78, pase: 64, aura: 70 }, look: { skin: "#F1C27D", hair: "#2A1D12", style: "buzz", beard: false } },
    ...
    // ---------- CAF ----------
    {
      ...
      players: [
        ...
        { name: "Deroy Duarte",        pos: "MED", num: 14, stats: { tiro: 60, defensa: 54, cabezazo: 50, pase: 68, aura: 56 }, look: { skin: "#A0663A", hair: "#0E0C0A", style: "curly", beard: false } },

        { name: "Ryan Mendes",         pos: "DEL", num: 20, stats: { tiro: 68, defensa: 42, cabezazo: 58, pase: 66, aura: 68 }, look: { skin: "#6B4226", hair: "#0E0C0A", style: "buzz", beard: false } },
        { name: "Dailon Livramento",   pos: "DEL", num: 19, stats: { tiro: 70, defensa: 38, cabezazo: 60, pase: 58, aura: 58 }, look: { skin: "#8D5524", hair: "#0E0C0A", style: "short", beard: false } },
    ...
    },
    {
      ...
      players: [
          ...
          { name: "Ayoub El Kaabi",      pos: "DEL", num:  9, stats: { tiro: 82, defensa: 44, cabezazo: 86, pase: 62, aura: 76 }, look: { skin: "#C68642", hair: "#0E0C0A", style: "buzz", beard: true } },
          { name: "Soufiane Rahimi",     pos: "DEL", num:  7, stats: { tiro: 78, defensa: 46, cabezazo: 58, pase: 76, aura: 72 }, look: { skin: "#C68642", hair: "#17130F", style: "short", beard: true } },
    ...
    },
    {
      ...
      players: [
          ...
          { name: "Yehvann Diouf",       pos: "POR", num:  1, stats: { atajadas: 74, reflejos: 76, salidas: 70, pase: 62, aura: 66 }, look: { skin: "#8D5524", hair: "#0E0C0A", style: "short", beard: false } },
          ...
          { name: "Niakhaté",            pos: "DEF", num: 19, stats: { tiro: 46, defensa: 79, cabezazo: 76, pase: 70, aura: 72 }, look: { skin: "#8D5524", hair: "#0E0C0A", style: "buzz", beard: true } },
          { name: "Ismail Jakobs",       pos: "DEF", num: 14, stats: { tiro: 58, defensa: 74, cabezazo: 64, pase: 76, aura: 68 }, look: { skin: "#A0663A", hair: "#17130F", style: "curly", beard: false } },

          { name: "Pape Matar Sarr",     pos: "MED", num: 18, stats: { tiro: 74, defensa: 72, cabezazo: 66, pase: 84, aura: 78 }, look: { skin: "#8D5524", hair: "#0E0C0A", style: "buzz", beard: false } },
          ...
          { name: "Habib Diarra",        pos: "MED", num: 15, stats: { tiro: 72, defensa: 66, cabezazo: 64, pase: 78, aura: 70 }, look: { skin: "#8D5524", hair: "#17130F", style: "curly", beard: false } },
          ...
          { name: "Nicolas Jackson",     pos: "DEL", num: 11, stats: { tiro: 82, defensa: 44, cabezazo: 70, pase: 70, aura: 74 }, look: { skin: "#8D5524", hair: "#0E0C0A", style: "curly", beard: false } },
    ...
    // ---------- CONCACAF ----------
    {
      ...
      players: [
        { name: "Maxime Crépeau", pos: "POR", num: 16, stats: { atajadas: 80, reflejos: 82, salidas: 78, pase: 74, aura: 70 }, look: { skin: "#F1C27D", hair: "#4A331F", style: "short", beard: true } },
        { name: "Dayne St. Clair", pos: "POR", num: 1, stats: { atajadas: 75, reflejos: 79, salidas: 71, pase: 86, aura: 65 }, look: { skin: "#6B4226", hair: "#17130F", style: "short", beard: true } },
        { name: "Alistair Johnston", pos: "DEF", num: 2, stats: { tiro: 68, defensa: 78, cabezazo: 78, pase: 75, aura: 77 }, look: { skin: "#F1C27D", hair: "#6B4F2A", style: "short", beard: true } },
        { name: "Moïse Bombito", pos: "DEF", num: 15, stats: { tiro: 54, defensa: 80, cabezazo: 78, pase: 76, aura: 77 }, look: { skin: "#6B4226", hair: "#17130F", style: "short", beard: true } },
        { name: "Alphonso Davies", pos: "DEF", num: 19, stats: { tiro: 78, defensa: 85, cabezazo: 74, pase: 88, aura: 85 }, look: { skin: "#6B4226", hair: "#17130F", style: "short", beard: false } },
        { name: "Stephen Eustáquio", pos: "MED", num: 7, stats: { tiro: 76, defensa: 78, cabezazo: 72, pase: 81, aura: 78 }, look: { skin: "#E0AC69", hair: "#17130F", style: "short", beard: true } },
        { name: "Ismaël Koné", pos: "MED", num: 8, stats: { tiro: 78, defensa: 78, cabezazo: 74, pase: 81, aura: 78 }, look: { skin: "#6B4226", hair: "#17130F", style: "short", beard: false } },
        { name: "Tajon Buchanan", pos: "MED", num: 17, stats: { tiro: 78, defensa: 62, cabezazo: 70, pase: 82, aura: 74 }, look: { skin: "#8D5524", hair: "#17130F", style: "short", beard: false } },
        { name: "Jonathan David", pos: "DEL", num: 10, stats: { tiro: 82, defensa: 44, cabezazo: 80, pase: 73, aura: 75 }, look: { skin: "#6B4226", hair: "#17130F", style: "short", beard: true } },
        { name: "Tani Oluwaseyi", pos: "DEL", num: 12, stats: { tiro: 76, defensa: 43, cabezazo: 77, pase: 68, aura: 70 }, look: { skin: "#6B4226", hair: "#17130F", style: "short", beard: true } },
    ...
    },
    {
      ...
      players: [
        { name: "Matt Freese",         pos: "POR", num: 24, stats: { atajadas: 78, reflejos: 75, salidas: 77, pase: 67, aura: 80 }, look: { skin: "#F1C27D", hair: "#6B4F2A", style: "short", beard: true } },
        { name: "Matt Turner",         pos: "POR", num: 1, stats:  { atajadas: 75, reflejos: 70, salidas: 71, pase: 72, aura: 74 }, look: { skin: "#F1C27D", hair: "#2A1D12", style: "short", beard: true } },
        ...
        { name: "Sergiño Dest",        pos: "DEF", num:  2, stats: { tiro: 69, defensa: 75, cabezazo: 70, pase: 80, aura: 74 }, look: { skin: "#C68642", hair: "#17130F", style: "curly", beard: false } },
        ...
        { name: "McKennie",            pos: "MED", num:  8, stats: { tiro: 74, defensa: 78, cabezazo: 76, pase: 79, aura: 78 }, look: { skin: "#6B4226", hair: "#17130F", style: "curly", beard: true } },
        { name: "Malik Tillman",       pos: "MED", num: 17, stats: { tiro: 80, defensa: 66, cabezazo: 72, pase: 81, aura: 80 }, look: { skin: "#8D5524", hair: "#17130F", style: "short", beard: false } },
        ...
        { name: "Balogun",             pos: "DEL", num:  9, stats: { tiro: 83, defensa: 40, cabezazo: 71, pase: 64, aura: 82 }, look: { skin: "#6B4226", hair: "#0E0C0A", style: "buzz", beard: false } },
    ...
    },
    {
      ...
      players: [
        ...
        { name: "Guillermo Ochoa",     pos: "POR", num: 13, stats: { atajadas: 74, reflejos: 76, salidas: 70, pase: 66, aura: 68 }, look: { skin: "#C68642", hair: "#0E0C0A", style: "short", beard: false } },
        ...
        { name: "Johan Vásquez",       pos: "DEF", num:  5, stats: { tiro: 48, defensa: 79, cabezazo: 74, pase: 72, aura: 72 }, look: { skin: "#A0663A", hair: "#0E0C0A", style: "short", beard: true } },
        { name: "Jorge Sánchez",       pos: "DEF", num:  2, stats: { tiro: 58, defensa: 72, cabezazo: 62, pase: 72, aura: 66 }, look: { skin: "#C68642", hair: "#17130F", style: "buzz", beard: false } },
        ...
        { name: "Gilberto Mora",       pos: "MED", num: 19, stats: { tiro: 72, defensa: 54, cabezazo: 52, pase: 82, aura: 74 }, look: { skin: "#C68642", hair: "#0E0C0A", style: "short", beard: false } },

        { name: "Julián Quiñones",     pos: "DEL", num: 16, stats: { tiro: 80, defensa: 46, cabezazo: 70, pase: 74, aura: 76 }, look: { skin: "#8D5524", hair: "#0E0C0A", style: "buzz", beard: true } },
    ...
    },
    {
      ...
      players: [
        ...
        { name: "Liberato Cacace",   pos: "DEF", num: 13, stats: { tiro: 50, defensa: 70, cabezazo: 60, pase: 70, aura: 62 }, look: { skin: "#E0AC69", hair: "#17130F", style: "short", beard: false } },
        ...
        { name: "Tim Payne",         pos: "DEF", num:  2, stats: { tiro: 38, defensa: 70, cabezazo: 70, pase: 54, aura: 64 }, look: { skin: "#F1C27D", hair: "#4A331F", style: "short", beard: true } },
        ...
        { name: "Matt Garbett",      pos: "MED", num:  7, stats: { tiro: 60, defensa: 58, cabezazo: 54, pase: 68, aura: 60 }, look: { skin: "#FFDBAC", hair: "#6B4F2A", style: "curly", beard: false } },
        ...
        { name: "Kosta Barbarouses", pos: "DEL", num: 17, stats: { tiro: 66, defensa: 44, cabezazo: 56, pase: 62, aura: 64 }, look: { skin: "#E0AC69", hair: "#17130F", style: "short", beard: true } },
    ...
    },
    {
      ...
      players: [
        ...
        { name: "Egil Selvik",       pos: "POR", num: 13, stats: { atajadas: 66, reflejos: 68, salidas: 60, pase: 48, aura: 55 }, look: { skin: "#FFDBAC", hair: "#8A6B3F", style: "short", beard: false } },

        { name: "Kristoffer Ajer",   pos: "DEF", num:  3, stats: { tiro: 42, defensa: 77, cabezazo: 74, pase: 62, aura: 62 }, look: { skin: "#FFDBAC", hair: "#C69C6D", style: "bun", beard: false } },
        { name: "Leo Østigård",      pos: "DEF", num:  4, stats: { tiro: 35, defensa: 76, cabezazo: 78, pase: 55, aura: 64 }, look: { skin: "#F1C27D", hair: "#6B4F2A", style: "short", beard: true } },
        { name: "Julian Ryerson",    pos: "DEF", num: 26, stats: { tiro: 52, defensa: 78, cabezazo: 64, pase: 70, aura: 66 }, look: { skin: "#F1C27D", hair: "#4A331F", style: "short", beard: true } },

        { name: "Martin Ødegaard",   pos: "MED", num: 10, stats: { tiro: 78, defensa: 55, cabezazo: 45, pase: 92, aura: 90 }, look: { skin: "#FFDBAC", hair: "#C69C6D", style: "short", beard: false } },
        { name: "Sander Berge",      pos: "MED", num:  8, stats: { tiro: 62, defensa: 72, cabezazo: 66, pase: 78, aura: 64 }, look: { skin: "#F1C27D", hair: "#2A1D12", style: "bun", beard: true } },
        ...
        { name: "Erling Haaland",    pos: "DEL", num:  9, stats: { tiro: 94, defensa: 40, cabezazo: 90, pase: 50, aura: 89 }, look: { skin: "#FFDBAC", hair: "#C69C6D", style: "long", beard: false } },
        { name: "Alexander Sørloth", pos: "DEL", num:  7, stats: { tiro: 84, defensa: 35, cabezazo: 88, pase: 58, aura: 72 }, look: { skin: "#F1C27D", hair: "#6B4F2A", style: "buzz", beard: true } },
