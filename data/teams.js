...
export const WC_DATA = {
  teams: [
    ...
    // ╔══════════════════════════════════════════════════════╗
    // ║ 1. SELECCIONES JUGABLES (16) — orden alfabético      ║
    // ╚══════════════════════════════════════════════════════╝
    {
      ...
      players: [
        ...
        { name: "Lautaro Martínez",    pos: "DEL", num: 22, stats: { tiro: 90, defensa: 42, cabezazo: 82, pase: 74, aura: 86 }, look: { skin: "#C68642", hair: "#17130F", style: "short", beard: false } },
    ...
    },
    {
      ...
      players: [
        ...
        { name: "Raphinha", pos: "DEL", num: 11, stats: { tiro: 91, defensa: 45, cabezazo: 70, pase: 87, aura: 91 }, look: { skin: "#C68642", hair: "#17130F", style: "short", beard: true } },
    ...
    },
    {
      ...
      players: [
        { name: "Crépeau",             pos: "POR", num: 16, stats: { atajadas: 74, reflejos: 76, salidas: 70, pase: 66, aura: 72 }, look: { skin: "#F1C27D", hair: "#2A1D12", style: "short", beard: true } },
        { name: "Dayne St. Clair",     pos: "POR", num:  1, stats: { atajadas: 72, reflejos: 74, salidas: 68, pase: 64, aura: 66 }, look: { skin: "#6B4226", hair: "#0E0C0A", style: "short", beard: false } },
        { name: "Alphonso Davies",     pos: "DEF", num: 19, stats: { tiro: 70, defensa: 76, cabezazo: 66, pase: 84, aura: 84 }, look: { skin: "#6B4226", hair: "#0E0C0A", style: "curly", beard: false } },
        { name: "Moïse Bombito",       pos: "DEF", num:  4, stats: { tiro: 46, defensa: 78, cabezazo: 72, pase: 68, aura: 70 }, look: { skin: "#6B4226", hair: "#17130F", style: "buzz", beard: false } },
        { name: "Alistair Johnston",   pos: "DEF", num:  2, stats: { tiro: 58, defensa: 76, cabezazo: 70, pase: 74, aura: 72 }, look: { skin: "#F1C27D", hair: "#4A331F", style: "short", beard: true } },
        { name: "Eustáquio",           pos: "MED", num:  7, stats: { tiro: 68, defensa: 72, cabezazo: 64, pase: 80, aura: 72 }, look: { skin: "#E0AC69", hair: "#17130F", style: "short", beard: true } },
        { name: "Ismaël Koné",         pos: "MED", num:  8, stats: { tiro: 70, defensa: 68, cabezazo: 66, pase: 78, aura: 68 }, look: { skin: "#6B4226", hair: "#17130F", style: "curly", beard: false } },
        { name: "Buchanan",            pos: "MED", num: 11, stats: { tiro: 74, defensa: 60, cabezazo: 60, pase: 76, aura: 70 }, look: { skin: "#6B4226", hair: "#0E0C0A", style: "long", beard: false } },
        { name: "Jonathan David",      pos: "DEL", num: 20, stats: { tiro: 85, defensa: 44, cabezazo: 70, pase: 74, aura: 80 }, look: { skin: "#6B4226", hair: "#0E0C0A", style: "buzz", beard: false } },
        { name: "Cyle Larin",          pos: "DEL", num: 17, stats: { tiro: 78, defensa: 42, cabezazo: 74, pase: 62, aura: 68 }, look: { skin: "#6B4226", hair: "#0E0C0A", style: "buzz", beard: true } },
      ],
    },
    {
    ...
    // ╔══════════════════════════════════════════════════════╗
    // ║ 2. RIVALES CLASIFICADOS — por confederación            ║
    // ╚══════════════════════════════════════════════════════╝
    ...
    // ---------- CONMEBOL ----------
    {
      id: "ECU", name: "Ecuador", flag: "🇪🇨", iso: "ec", confed: "CONMEBOL", rating: 77,
      kit: { shirt: "#FFD100", accent: "#003DA5" },
      figures: [
        { name: "Moisés Caicedo", pos: "MED" },
        { name: "Enner Valencia", pos: "DEL" },
        { name: "Kendry Páez", pos: "MED" },
        { name: "Piero Hincapié", pos: "DEF" },
        { name: "Galíndez", pos: "POR" },
      ],
    },
    {
      id: "PAR", name: "Paraguay", flag: "🇵🇾", iso: "py", confed: "CONMEBOL", rating: 73,
      kit: { shirt: "#D0103A", accent: "#FFFFFF" },
      figures: [
        { name: "Almirón", pos: "DEL" },
        { name: "Julio Enciso", pos: "MED" },
        { name: "Sanabria", pos: "DEL" },
        { name: "Gustavo Gómez", pos: "DEF" },
        { name: "Gatito Fernández", pos: "POR" },
      ],
    },
    ...
    // ╔══════════════════════════════════════════════════════╗
    // ║ 3. NO CLASIFICADOS — fuera del sorteo, para futuras    ║
    // ║    features (qualified: false)                          ║
    // ╚══════════════════════════════════════════════════════╝
    {
