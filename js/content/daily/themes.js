...
export const EVENT_THEMES = {
  ...
  fisico:        { icon: "🧑‍⚕️", name: "Estado físico", color: "text-emerald-400" },
  vestuario:     { icon: "🎭", name: "Vestuario",      color: "text-purple-400" },
  entorno:       { icon: "📣", name: "Entorno",        color: "text-sky-400" },
};
