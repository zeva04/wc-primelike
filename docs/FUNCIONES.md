...
| `rivalFiloLevel(team, koRound)` | **philosophy** (F2+R2): nivel de identidad rival por jerarquía (≥84 Consolidada · 78-83 En desarrollo · resto Aprendiendo) — y desde CUARTOS (`FILO_MADURA_DESDE`=3) +1 nivel, tope 2: la identidad MADURA con el torneo. `rivalFilo(team, koRound)` lo empaqueta para Match/scouting. |
