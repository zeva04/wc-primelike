...
| `PASE_MIX` / `paseMix(p)` | **ratings** (Odisea sprint 1): la mezcla 60/40 corto/largo que usa todo lo que todavía necesita UN número de pase (poder del medio, precisión del panel, perfil del rival). Es la COSTURA declarada: la segunda mitad del sprint la reemplaza por el pase que corresponda a cada jugada y esta constante desaparece. |
