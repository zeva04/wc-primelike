...
- **Tabla de goleadores del torneo**: el hub muestra el top 5 de artilleros del Mundial (clic → tabla completa). Tus goles son los reales de tu plantel; los de los demás equipos se reparten entre sus figuras según posición (los delanteros marcan más) cada vez que el mundo simula un partido — así la tabla se llena de nombres de todas las selecciones a medida que avanza el torneo.
...
- **Momento del jugador**: cada jugador tuyo lleva una **forma 1..7** (nace neutra en 4) que sube y baja con su rendimiento real — goles, penales fallados o atajados, vallas invictas y el resultado del equipo — y decae sola si no se alimenta. Afecta **todas sus stats en ±2% por nivel (tope ±4%)**: se ve en la ficha (flechas ▲/▼ y % aplicado), en la cancha y en el hub como chips 🔥 (en racha) / ❄️ (congelado), y el diario titula las rachas y las crisis. Los rivales **no** tienen Momento: es una ventaja del DT humano vigilada por el smoke test (si el balance deriva, el efecto se recorta — hoy los penales/tandas y el orden del once automático van sin él).
- **Moral del equipo**: el ánimo colectivo (1..100, 5 bandas de "Por el suelo" a "Por las nubes") reacciona a los resultados y a **cómo** se dan: un gol agónico del triunfo enciende más que ganar de trámite, que te empaten al final duele, pasar de ronda celebra. Visible en el hub y en el diario; algunos eventos del calendario la mueven. Por ahora es narrativa — su efecto en el partido (tipo y número de ocasiones) llega en una próxima iteración.
